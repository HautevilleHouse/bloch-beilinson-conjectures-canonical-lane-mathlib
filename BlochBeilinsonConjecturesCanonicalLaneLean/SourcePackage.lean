/-!
# Source package model for `bloch-beilinson-conjectures-canonical-lane`
...
def sourceCheckoutHead : String := "e04ec5dfb4fa84b6b9c65e259e6c90334c0f1cea"
def sourceCheckoutClean : Bool := true

def sourceFiles : List SourceFile := [
  { path := "scripts/bb_closure_guard.py", sha256 := "329c976ff091a80e1e775dd0433f36de7740b0fa57a3dd4cc79480cd30f0fb20", functionCount := 9, classCount := 0, assignmentCount := 8, parseOk := true },
...
def sourceFunctions : List SourceFunctionDecl := [
  { file := "scripts/bb_closure_guard.py", name := "_finite", args := ["v"], returns := "bool", doc := "", line := 20, isAsync := false },
  { file := "scripts/bb_closure_guard.py", name := "_resolve", args := ["p"], returns := "Path", doc := "", line := 24, isAsync := false },
  { file := "scripts/bb_closure_guard.py", name := "_bootstrap", args := ["path"], returns := "None", doc := "", line := 29, isAsync := false },
  { file := "scripts/bb_closure_guard.py", name := "_load_registry", args := ["path"], returns := "", doc := "", line := 35, isAsync := false },
  { file := "scripts/bb_closure_guard.py", name := "_load_sigma", args := ["path"], returns := "", doc := "", line := 44, isAsync := false },
  { file := "scripts/bb_closure_guard.py", name := "_entry", args := ["constants", "key"], returns := "", doc := "", line := 61, isAsync := false },
  { file := "scripts/bb_closure_guard.py", name := "compute_report", args := ["data", "sigma_star", "strict"], returns := "", doc := "", line := 71, isAsync := false },
  { file := "scripts/bb_closure_guard.py", name := "append_history", args := ["path", "report"], returns := "", doc := "", line := 97, isAsync := false },
  { file := "scripts/bb_closure_guard.py", name := "main", args := [], returns := "", doc := "", line := 104, isAsync := false },
...
def sourceAssignments : List SourceAssignmentDecl := [
  { file := "scripts/bb_closure_guard.py", name := "SCRIPT_DIR", value := "Path(__file__).resolve().parent", line := 10 },
  { file := "scripts/bb_closure_guard.py", name := "PROJECT_ROOT", value := "SCRIPT_DIR.parent", line := 11 },
  { file := "scripts/bb_closure_guard.py", name := "PRIMARY_KEYS", value := "[\"kappa_filtration\", \"sigma_regulator\", \"kappa_compact\", \"rho_rigidity\", \"motivic_transfer\"]", line := 12 },
  { file := "scripts/bb_closure_guard.py", name := "COHERENCE_KEY", value := "\"eps_coh\"", line := 13 },
  { file := "scripts/bb_closure_guard.py", name := "DEFAULT_REGISTRY", value := "\"artifacts/constants_registry.json\"", line := 14 },
  { file := "scripts/bb_closure_guard.py", name := "DEFAULT_STITCH", value := "\"artifacts/stitch_constants.json\"", line := 15 },
  { file := "scripts/bb_closure_guard.py", name := "DEFAULT_OUT", value := "\"repro/certificate_runtime.json\"", line := 16 },
  { file := "scripts/bb_closure_guard.py", name := "DEFAULT_HISTORY", value := "\"repro/drift_guard_runs.jsonl\"", line := 17 },
...
def constantSpecs : List ConstantSpec := [
  { group := "constants", key := "kappa_filtration", status := "derived_numeric", formula := "c_filtration_raw * filtration_density_raw - e_filtration_raw", sourceSection := "paper/BLOCH_BEILINSON_CONJECTURES_PREPRINT.md Section 4.5 / Appendix A", validation := "required_positive", componentKeys := ["c_filtration_raw", "e_filtration_raw", "filtration_density_raw"] },
  { group := "constants", key := "sigma_regulator", status := "derived_numeric", formula := "regulator_floor_raw - cycle_loss_raw - restart_loss_raw", sourceSection := "paper/BLOCH_BEILINSON_CONJECTURES_PREPRINT.md Section 5.2 / Appendix B", validation := "required_positive", componentKeys := ["cycle_loss_raw", "regulator_floor_raw", "restart_loss_raw"] },
  { group := "constants", key := "kappa_compact", status := "derived_numeric", formula := "1.0 / (1.0 + delta_comp_sup_raw)", sourceSection := "paper/BLOCH_BEILINSON_CONJECTURES_PREPRINT.md Section 5.3 / Appendix C", validation := "required_positive", componentKeys := ["delta_comp_sup_raw"] },
  { group := "constants", key := "rho_rigidity", status := "derived_numeric", formula := "rho_rigidity_raw", sourceSection := "paper/BLOCH_BEILINSON_CONJECTURES_PREPRINT.md Section 6.1 / Appendix D", validation := "required_positive", componentKeys := ["rho_rigidity_raw"] },
  { group := "constants", key := "motivic_transfer", status := "derived_numeric", formula := "c_motive_raw * transfer_gain_raw - e_motive_raw", sourceSection := "paper/BLOCH_BEILINSON_CONJECTURES_PREPRINT.md Section 6.2 / Appendix E.4", validation := "required_positive", componentKeys := ["c_motive_raw", "e_motive_raw", "transfer_gain_raw"] },
  { group := "constants", key := "eps_coh", status := "derived_numeric", formula := "eps_coh_raw", sourceSection := "paper/BLOCH_BEILINSON_CONJECTURES_PREPRINT.md Appendix E.6", validation := "required_nonnegative", componentKeys := ["eps_coh_raw"] },
  { group := "stitch", key := "sigma_star_can", status := "derived_numeric", formula := "sigma_star_can_raw", sourceSection := "paper/BLOCH_BEILINSON_CONJECTURES_PREPRINT.md Section 5 / stitch constants", validation := "required_positive", componentKeys := ["sigma_star_can_raw"] }
]

def registryConstants : List RegistryConstant := [
  { key := "eps_coh", value := "0.0", theoremLevel := true, status := "derived_numeric", source := "artifacts/constants_extracted.json#eps_coh", sourceSection := "paper/BLOCH_BEILINSON_CONJECTURES_PREPRINT.md Appendix E.6" },
  { key := "kappa_compact", value := "0.8038585209003215", theoremLevel := true, status := "derived_numeric", source := "artifacts/constants_extracted.json#kappa_compact", sourceSection := "paper/BLOCH_BEILINSON_CONJECTURES_PREPRINT.md Section 5.3 / Appendix C" },
  { key := "kappa_filtration", value := "1.095567", theoremLevel := true, status := "derived_numeric", source := "artifacts/constants_extracted.json#kappa_filtration", sourceSection := "paper/BLOCH_BEILINSON_CONJECTURES_PREPRINT.md Section 4.5 / Appendix A" },
  { key := "motivic_transfer", value := "1.0305400000000002", theoremLevel := true, status := "derived_numeric", source := "artifacts/constants_extracted.json#motivic_transfer", sourceSection := "paper/BLOCH_BEILINSON_CONJECTURES_PREPRINT.md Section 6.2 / Appendix E.4" },
  { key := "rho_rigidity", value := "1.078", theoremLevel := true, status := "derived_numeric", source := "artifacts/constants_extracted.json#rho_rigidity", sourceSection := "paper/BLOCH_BEILINSON_CONJECTURES_PREPRINT.md Section 6.1 / Appendix D" },
  { key := "sigma_regulator", value := "1.075", theoremLevel := true, status := "derived_numeric", source := "artifacts/constants_extracted.json#sigma_regulator", sourceSection := "paper/BLOCH_BEILINSON_CONJECTURES_PREPRINT.md Section 5.2 / Appendix B" }
]
