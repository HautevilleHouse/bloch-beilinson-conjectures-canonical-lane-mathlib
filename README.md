# Bloch Beilinson Conjectures — Canonical Lane Mathlib
...
```bash
git clone https://github.com/HautevilleHouse/bloch-beilinson-conjectures-canonical-lane-mathlib.git
cd bloch-beilinson-conjectures-canonical-lane-mathlib
lake exe
lake build
```
